    ...
    <div class="container">
        ...
        <section class="security-tests">
            ...
            <div class="test-card">
                ...
                <a href="api_key_leak_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="account_takeover_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="crlf_injection_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="cve_exploit_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="client_side_path_traversal_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="dns_rebinding_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="dos_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="dependency_confusion_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="external_variable_modification_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="headless_browser_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="hidden_parameters_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="initial_access_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="reverse_proxy_misconfig_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="saml_injection_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="ssi_injection_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="type_juggling_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="web_cache_deception_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="web_sockets_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="xslt_injection_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="dom_clobbering_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="clickjacking_test.php" class="btn">테스트 시작</a>
            </div>
            ...
            <div class="test-card">
                ...
                <a href="zip_slip_test.php" class="btn">테스트 시작</a>
            </div>
...
' +
        ...
        <!-- 진행률 표시 -->
            ...
            <h2>📊 테스트 현황</h2>
            <div style="background: #e8f5e8; padding: 20px; border-radius: 8px; border-left: 5px solid #28a745;">
                <h3 style="color: #28a745; margin-bottom: 15px;">✅ 구현 완료된 취약점 테스트 (40개)</h3>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; margin-bottom: 20px;">
                    <span>• SQL Injection</span>
                    <span>• XSS (Cross-Site Scripting)</span>
                    <span>• Command Injection</span>
                ...
                <div style="background: #ffffff; padding: 15px; border-radius: 5px; margin-top: 15px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span><strong>PayloadsAllTheThings 커버리지:</strong></span>
                        <span style="font-size: 18px; color: #28a745;"><strong>~70% (40/57개 카테고리)</strong></span>
                    </div>
                    <div style="width: 100%; background: #e9ecef; height: 10px; border-radius: 5px; margin-top: 10px;">
                        <div style="width: 70%; background: #28a745; height: 100%; border-radius: 5px;"></div>
                    </div>
                </div>
            </div>
        </section>
