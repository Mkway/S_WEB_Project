...
class TestPage {
    ...
    public function __construct(string $page_title, string $description, array $payloads, array $defense_methods, array $references, ?string $analysis_file = null) {
    ...
    private function render(): void {
        ...
        $analysis_file = $this->analysis_file;
